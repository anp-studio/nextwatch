...
::callout{type="info"}
Most local issues are resolved by confirming `.env` values and reinstalling dependencies in the correct directory.
::
...
- Ensure correct endpoint paths, especially `/api/recommend`, `/api/movies/search`, and `/api/tmdb/...`
