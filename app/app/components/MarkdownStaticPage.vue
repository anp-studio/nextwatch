  ...
  >
    ...
    >
      <div
        ...
        class="mb-6 flex flex-wrap items-center gap-3 border-b border-outline-variant pb-5"
      >
        <div
      ...
      <div
        class="max-w-4xl space-y-6 text-sm leading-8 text-on-surface sm:text-base [&_a]:font-semibold [&_a]:text-primary [&_a]:underline-offset-4 hover:[&_a]:underline [&_blockquote]:rounded-[1.25rem] [&_blockquote]:border-l-2 [&_blockquote]:border-primary/60 [&_blockquote]:bg-surface-container-high [&_blockquote]:px-4 [&_blockquote]:py-3 [&_blockquote]:text-on-surface [&_h1]:mt-0 [&_h1]:text-3xl [&_h1]:font-semibold [&_h1]:tracking-[-0.04em] [&_h1]:text-on-background [&_h2]:mt-10 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:tracking-[-0.03em] [&_h2]:text-on-background [&_h2]:first:mt-0 [&_h3]:mt-8 [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:tracking-[-0.02em] [&_h3]:text-on-background [&_hr]:border-outline-variant [&_li]:ml-1 [&_li]:pl-1 [&_li]:text-on-surface [&_li]:marker:text-primary [&_ol]:list-decimal [&_ol]:space-y-2 [&_ol]:pl-6 [&_p]:whitespace-pre-line [&_p]:text-on-surface [&_strong]:text-on-background [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-6"
      >
